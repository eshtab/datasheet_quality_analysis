...
- manual cleaning: 
  - created blank datasheet templates for both 2018 and 2021
    - then filled datasheets from their original formatting to standardized formatting
      ...
      other sections/appendices etc before/after it or had images in the datasheet. to be able to automate any type of 
    ...
    - made it easier to identify diff elements of a datasheet (header, question, answer)
      ...
      - added no to "any other comments" to ensure completion % was accurate
...
- usage of datasheets has to be standardized, and guidelines have to enforce standard formatting to ensure that future analyses can be performed 
\newpage
